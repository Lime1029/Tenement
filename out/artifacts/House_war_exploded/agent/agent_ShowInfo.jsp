        ...
        <div class="col-md-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <h5>&nbsp;你好，${sessionScope.agent.name}，以下展示您的个人信息</h5>
                </div>
                <ul class="list-group" >
                    <li class="list-group-item">联系方式：&nbsp;&nbsp;${sessionScope.agent.telephone}</li>
                    <li class="list-group-item">登录密码：&nbsp;&nbsp;${sessionScope.agent.password}</li>
                </ul>
            </div>
        </div>
    </div>
