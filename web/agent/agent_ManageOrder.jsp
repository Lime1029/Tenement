...
<div>
    <div class="row" style="height: 100%">
            ...
            <nav class="navbar" style="background-color: aliceblue">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="agent_AddOrder.jsp" style="color: black">添加订单</a>
                        <a class="nav-link" href="agent_ManageOrder.jsp" style="color: black">我管理的订单</a>
                    </li>
                </ul>
            </nav>
        </div>
        ...
        <script type="text/javascript">
            console.log("${orders}")//将内容输出在控制台中，方便调试。
        </script>
    </div>
